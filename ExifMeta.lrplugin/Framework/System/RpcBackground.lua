--[[
        ...
        RpcBackground task - designed to be extended.
...
local RpcBackground, dbg = Background:newClass{ className = 'RpcBackground' }



--- Constructor for extending class.
--
function RpcBackground:newClass( t )
...
--
function RpcBackground:init( call )
    repeat
        repeat
...
--
function RpcBackground:process( call )
...
--
function RpcBackground:sendAndReceive( command, ... )
    local sts, msgOrVals
...
function RpcBackground:finale( call, status, message )
