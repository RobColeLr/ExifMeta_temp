...
--                                      <li>width_in_chars - edit-field width (in fat characters).</ul>
--                                      <li>height_in_lines - edit-field height (in lines).</ul>
--
--  @usage          self-wrapped.
--      
...
--- Show information, and remember answer for a while. *** @deprecated - uses non-standard dialog box. workaround has been simply to store answer in a call var, until end of call..
--
