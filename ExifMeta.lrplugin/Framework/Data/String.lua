...
--
--  @returns root (string, always) root will always be non-nil, and "shouldn't" be blank.
--  @returns leaves (string, always) leaves will be in least-sig-first order, i.e. path leaf will be at index 1. @19/Nov/2013 16:37 (long after initial writing/testing), I'm not sure if it's possible for last leaf to be same as root - I think not. Not sure if it can be blank either.
--
